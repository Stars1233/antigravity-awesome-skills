...
description: "Use antigravity-awesome-skills with Jetski/Cortex without hitting context-window overflow with 1,444+ skills."
---

# Jetski/Cortex + Gemini: safe integration with 1,444+ skills
...
With 1,444+ skills, this approach fills the context window before user messages are even added, causing truncation.
