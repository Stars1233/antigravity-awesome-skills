<!-- registry-sync: version=10.9.0; skills=1444; stars=36115; updated_at=2026-05-03T06:51:10+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,444+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,444+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,444+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,444+ Skills](#browse-1444-skills)
...
If you want a faster answer than "browse all 1,444+ skills", start with a tool-specific guide:
